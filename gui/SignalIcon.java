...
import scrt.common.packet.AutomaticOrder;
import scrt.common.packet.ClearOrder;
...
public class SignalIcon extends CTCIcon {
	...
	JMenuItem stick = new JMenuItem("Desactivar cierre en stick");
	...
	public void update()
	{
		...
		else
		{
			...
			stick.setText(sig.stickClose ? "Desactivar cierre en stick" : "Cierre en stick");
		}
	}
}
